...
G4AntiSexaquark* G4AntiSexaquark::fInstance = nullptr;


G4AntiSexaquark::G4AntiSexaquark( const G4String& aName, G4double mass, G4double width,
				  ...
				  G4bool shortlived, const G4String& subType,
...
G4AntiSexaquark::~G4AntiSexaquark() {}


G4AntiSexaquark* G4AntiSexaquark::Definition() {
  if ( fInstance == nullptr ) {
    fInstance = new G4AntiSexaquark( "anti_sexaquark",  // name
    ...
    G4cout << "G4AntiSexaquark is created." << G4endl;
  }
  return fInstance;
}


G4AntiSexaquark* G4AntiSexaquark::AntiSexaquarkDefinition() {
  return Definition();
}


G4AntiSexaquark* G4AntiSexaquark::AntiSexaquark() {
  return Definition();
}
